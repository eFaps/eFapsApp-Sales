    ...
    extends DocumentSum
{
        ...
        throws EFapsException
    {
        ...
        insert.add(CISales.Quotation.CrossTotal, getCrossTotal(calcList));
        insert.add(CISales.Quotation.NetTotal, getNetTotal(calcList));
        ...
        insert.add(CISales.Quotation.CurrencyId, _parameter.getParameterValue("rateCurrencyId"));
        insert.add(CISales.Quotation.RateCurrencyId, _parameter.getParameterValue("rateCurrencyId"));
