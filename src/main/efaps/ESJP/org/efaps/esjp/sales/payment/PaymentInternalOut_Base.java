    ...
    extends AbstractPaymentDocument
{
        ...
        throws EFapsException
    {
        ...
        if (Sales.PAYMENTOUT_INTERNAL_CREATESTATUS.exists()) {
            ret = Status.find(CISales.PaymentInternalOutStatus, Sales.PAYMENTOUT_INTERNAL_CREATESTATUS.get());
        }
        return ret;
    }
    ...
    public CIType getCIType()
        throws EFapsException
    {
        return CISales.PaymentInternalOut;
    }
}
