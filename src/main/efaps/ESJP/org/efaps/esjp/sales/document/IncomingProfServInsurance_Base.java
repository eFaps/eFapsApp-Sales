 ...
 *
 */
@EFapsUUID("c3f4c680-3c75-4709-bbf8-cd4a8a9e96f7")
@EFapsApplication("eFapsApp-Sales")
public abstract class IncomingProfServInsurance_Base
    extends AbstractDocumentTax
{
        ...
        throws EFapsException
    {
        ...
        if (docInst != null && docInst.isValid()) {
            ...
            try {
                ...
                createdDoc.addValue(IncomingProfServInsurance_Base.AMOUNTVALUE, retention);
    ...
    protected void connectDoc(final Parameter _parameter,
        ...
        throws EFapsException
    {
        final Insert relInsert = new Insert(CISales.IncomingProfServInsurance2IncomingProfServReceipt);
        relInsert.add(CISales.IncomingProfServInsurance2IncomingProfServReceipt.FromLink, _taxDoc.getInstance());
        relInsert.add(CISales.IncomingProfServInsurance2IncomingProfServReceipt.ToLink, _origDoc.getInstance());
        relInsert.execute();
    }
    ...
    protected Type getType4create4Doc(final Parameter _parameter)
        throws EFapsException
    {
        return CISales.IncomingProfServInsurance.getType();
    }
        ...
        throws EFapsException
    {
        ...
        if (_parameter.getInstance() != null && _parameter.getInstance().isValid()
                        && _parameter.getInstance().getType().isKindOf(CISales.IncomingProfServInsurance.getType())) {
            final PrintQuery print = new PrintQuery(_parameter.getInstance());
            final SelectBuilder sel = SelectBuilder.get()
                            .linkfrom(CISales.IncomingProfServInsurance2IncomingProfServReceipt.FromLink)
                            .linkto(CISales.IncomingProfServInsurance2IncomingProfServReceipt.ToLink)
    ...
    protected void add2QueryBldr(final Parameter _parameter,
        ...
        throws EFapsException
    {
        final QueryBuilder queryBldr = new QueryBuilder(CISales.IncomingProfServInsurance);
        queryBldr.addType(CISales.IncomingProfServInsurance, CISales.IncomingPerceptionCertificate);
        queryBldr.addWhereAttrNotEqValue(CISales.DocumentAbstract.StatusAbstract,
                        ...
                        Status.find(CISales.IncomingProfServInsuranceStatus.Canceled),
        ...
        throws EFapsException
    {
        ...
        js.append("<script type=\"text/javascript\">\n")
                        ...
                        .append(getSetFieldReadOnlyScript(_parameter, "InsuranceValue"))
