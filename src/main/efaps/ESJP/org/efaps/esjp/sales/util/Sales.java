...
public final class Sales
{
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute ACCOUNTCASHDESK_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "AccountCashDesk.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute ACCOUNTCASHDESK_FILETRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "AccountCashDesk.ActivateFilesStructurBrowser")
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute CREDITNOTE_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "CreditNote.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute CREDITNOTE_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "CreditNote.ActivateFilesStructurBrowser")
                    .description("Activate the possiblity to upload Files incl. FolderStructure");
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute DELIVERYNOTE_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute DELIVERYNOTE_MANUALWEIGHT = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "DeliveryNote.ManualCrossWeight")
                    .description("Activate the manual seeting of crossweight");
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute INCOMINGDETRACTION_FILETRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENT_CASH_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.in.Cash.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENT_CASH_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.in.Cash.ActivateFilesStructurBrowser")
                    .description("Activate the possiblity to upload Files incl. FolderStructure");
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENT_DEPOSIT_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.in.Deposit.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENT_DEPOSIT_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.in.Deposit.ActivateFilesStructurBrowser")
                    .description("Activate the possiblity to upload Files incl. FolderStructure");
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENTOUT_DETRACTION_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.out.Detraction.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENTOUT_DETRACTION_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
    ...
    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENTOUT_INTERNAL_FILE = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.out.Internal.ActivateFiles")
                    .description("Activate the possiblity to upload Files");

    /** See description. */
    @EFapsSysConfAttribute
    public static final BooleanSysConfAttribute PAYMENTOUT_INTERNAL_FILESTRBROWSER = new BooleanSysConfAttribute()
                    .sysConfUUID(Sales.SYSCONFUUID)
                    .key(Sales.BASE + "payment.out.Internal.ActivateFilesStructurBrowser")
                    .description("Activate the possiblity to upload Files incl. FolderStructure");
    ...
    public static final PropertiesSysConfAttribute REPORT_ACCOUNTS4CONTACT = new PropertiesSysConfAttribute()
                    ...
                    .addDefaultValue("Type04", CISales.Invoice.getType().getName())
                    .addDefaultValue("Type05", CISales.Receipt.getType().getName())
                    .addDefaultValue("Type06", CISales.Reminder.getType().getName())
                    .addDefaultValue("Type07", CISales.IncomingExchange.getType().getName())
                    .addDefaultValue("StatusGroup01", CISales.IncomingInvoiceStatus.getType().getName())
                    .addDefaultValue("Status01", CISales.IncomingInvoiceStatus.Open.key)
                    .addDefaultValue("StatusGroup02", CISales.IncomingReceiptStatus.getType().getName())
                    .addDefaultValue("Status02", CISales.IncomingReceiptStatus.Open.key)
                    ...
                    .addDefaultValue("StatusGroup04", CISales.InvoiceStatus.getType().getName())
                    .addDefaultValue("Status04", CISales.InvoiceStatus.Open.key)
                    .addDefaultValue("StatusGroup05", CISales.ReceiptStatus.getType().getName())
                    .addDefaultValue("Status05", CISales.ReceiptStatus.Open.key)
                    .addDefaultValue("StatusGroup06", CISales.ReminderStatus.getType().getName())
                    .addDefaultValue("Status06", CISales.ReminderStatus.Open.key)
                    .addDefaultValue("StatusGroup07", CISales.IncomingExchangeStatus.getType().getName())
                    .addDefaultValue("Status07", CISales.IncomingExchangeStatus.Open.key)
                    ...
                    .addDefaultValue("PAID.Type04", CISales.Invoice.getType().getName())
                    .addDefaultValue("PAID.Type05", CISales.Receipt.getType().getName())
                    .addDefaultValue("PAID.Type06", CISales.Reminder.getType().getName())
                    .addDefaultValue("PAID.Type07", CISales.IncomingExchange.getType().getName())
                    ...
                    .addDefaultValue("PAID.StatusGroup04", CISales.InvoiceStatus.getType().getName())
                    .addDefaultValue("PAID.Status04", "!" + CISales.InvoiceStatus.Replaced.key)
                    .addDefaultValue("PAID.StatusGroup05", CISales.ReceiptStatus.getType().getName())
                    .addDefaultValue("PAID.Status05", "!" + CISales.ReceiptStatus.Replaced.key)
                    .addDefaultValue("PAID.StatusGroup06", CISales.ReminderStatus.getType().getName())
                    .addDefaultValue("PAID.Status06", "!" + CISales.ReminderStatus.Replaced.key)
                    .addDefaultValue("PAID.StatusGroup07", CISales.IncomingExchangeStatus.getType().getName())
                    .addDefaultValue("PAID.Status07", "!" + CISales.IncomingExchangeStatus.Canceled.key)
