    ...
    extends AbstractPaymentIn
{
        ...
        throws EFapsException
    {
        ...
        if (CIFormSales.Sales_PaymentCheckForm.currencyLink.name.equals(field.getName())) {
            final List<Map<String, String>> list = new ArrayList<Map<String, String>>();
            final Map<String, String> map = new HashMap<String, String>();

            final Instance newInst = Instance.get(CIERP.Currency.getType(),
                        _parameter.getParameterValue(CIFormSales.Sales_PaymentCheckWithOutDocForm.currencyLink.name));
