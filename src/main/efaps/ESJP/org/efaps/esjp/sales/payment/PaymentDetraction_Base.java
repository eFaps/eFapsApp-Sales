    ...
    extends AbstractPaymentIn
{
        ...
        throws EFapsException
    {
        ...
        if (Sales.PAYMENT_DETRACTION_CREATESTATUS.exists()) {
            ret = Status.find(CISales.PaymentDetractionStatus, Sales.PAYMENT_DETRACTION_CREATESTATUS.get());
        }
        return ret;
    }
    ...
    public CIType getCIType()
        throws EFapsException
    {
        return CISales.PaymentDetraction;
    }
}
